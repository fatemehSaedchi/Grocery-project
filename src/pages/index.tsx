        ...
        <>
            ...
            <Section>
                <div className="flex justify-between mb-[50px]">
                    <h2 className="text-heading4 xl:text-heading3 text-blue-300">Popular Products</h2>
            ...
            <Section>
                <div className="flex justify-between mb-[50px]">
                    <h2 className="text-heading4 xl:text-heading3 text-blue-300">Popular Fruits</h2>
                    <div className="flex items-center gap-3">
                        <IconBox
            ...
            <Section>
                <div className="flex justify-between mb-[50px]">
                    <h2 className="text-heading4 xl:text-heading3 text-blue-300">Best Sellers</h2>
                </div>
