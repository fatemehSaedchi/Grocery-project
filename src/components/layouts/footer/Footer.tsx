            ...
            <div className="flex flex-col md:flex-row justify-between flex-wrap gap-[16px] divide-y-2 md:divide-y-0 mb-[70px]">
                ...
                <div className="pt-4 md:pt-0">
                    ...
                    <div className="flex items-center gap-6 justify-center xl:justify-start pt-4 lg:pt-5">
                        <Link href="#">
                            <ImageView src={"/assets/images/va724oeh 1.png"} alt={"Download app from apple store"} width={129} height={39}/>
                        </Link>
                        <Link href="#">
                            <ImageView src={"/assets/images/17kw6njp 1.png"} alt={"Download app from google play"} width={129} height={39}/>
                        </Link>
                    </div>
