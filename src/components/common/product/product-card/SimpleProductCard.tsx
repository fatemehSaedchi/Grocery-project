...
export function SimpleProductCard({data}: Props) {
    return (
        <div className="group border-[1px] border-gray-200 hover:border-green-150 rounded-[10px] hover:shadow-[20px_20px_40px_0_rgba(24,24,24,0.07)] relative p-3 md:p-4 xl:px-5 xl:pb-5 lg:pt-[65px] h-full">
            ...
            <Badge badge={data.label} sale_price={data.sale_price} price={data.price}/>
            ...
            <div className="flex flex-col gap-2">
                ...
                <Link href={'#'}><h3
                    className="text-heading-sm text-blue-300 max-h-[50px] overflow-hidden">{data.title}</h3></Link>
            ...
            <div className="flex items-center justify-between mt-3">
                <div>
                    ...
                    <span className="text-heading-sm line-through text-gray-500 ml-1">${data.price}</span>
                </div>
